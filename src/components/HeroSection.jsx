...
const HeroSection = () => {
  return (
    <section className="hero-section min-h-screen flex items-center overflow-hidden" id="hero">
      {/* Background pattern */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <Button 
                className="bg-silogistik-orange-500 hover:bg-silogistik-orange-600 text-white px-6 py-3 text-lg font-medium transition-all duration-300" 
                href="#pricing"
              >
                Mulai Gratis
              ...
              <Button 
                variant="outline" 
                className="text-silogistik-blue-500 border-2 border-silogistik-blue-500 hover:bg-silogistik-blue-50 px-6 py-3 text-lg font-medium transition-all duration-300" 
                href="#demo"
              >
                Demo Produk
                <ArrowRight className="ml-2" size={20} />
